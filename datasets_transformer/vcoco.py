...
from util_transformer.box_ops import box_xyxy_to_cxcywh
...
hoi_interaction_names = json.loads(
    open(r'D:\2025春PPT\模式识别课设\代码\transformer\transformer\data\vcoco_verb_names.json', 'r').readlines()[0])['verb_names']
